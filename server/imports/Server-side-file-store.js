...
const IMAGE_BASE_URL = "https://simple-social-media.s3.ca-central-1.amazonaws.com/"
    ...
    onAfterUpload(fileRef) {
      ...
      _.each(fileRef.versions, (vRef, version) => {
        ...
        FeedsCollection.insert({
          userId: fileRef.meta.userId, 
          createdAt: Date.now(), 
          updatedAt: Date.now(), 
          type: "Image",
          imageLink: IMAGE_BASE_URL+filePath
        })
